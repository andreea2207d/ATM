  ...
  <body>
	...
	<nav class="navbar navbar-light bg-light">
	  ...
	  <form class="form-inline p-10">
		 <div class="navbar-brand">OnlineBanking
			...
			<a href="#" class="btn btn-outline-secondary active" role="button">Add funds</a>
	...
	<div class="row">
 	 ...
 	 <div class="col-sm-4 mb">
 	 	<h4 class="mb-4 mt-3 ml-3">Add funds</h4>
	<form method="post">
		  <div class="form-group">
			  ...
			  %>
		    <label for="deposit_id">Account number:</label>
		  ...
		  <div class="form-group">
			...
			<div class="form-group">
		  		<button class="btn btn-light">Add funds</button>
			</div>
		</form>
	</div>
	</div>
