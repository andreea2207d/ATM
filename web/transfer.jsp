...
<nav class="navbar navbar-light bg-light">
	<div class="navbar-header">
		<form class="form-inline p-10">
			...
			<a href="#" class="btn btn-outline-secondary active" role="button">Transfer</a>
...
<div class="row">
	...
	<div class="col-sm-4 mb">
		<h4 class="mb-4 mt-3 ml-3">Transfer money</h4>
		<form method="post">
			<div class="form-group">
					...
					%>
				<label for="deposit_id_from">Account number:</label>
				<select class="form-control" id="deposit_id_from" name="deposit_id_from">
					<%
			...
			<div class="form-group">
				<label for="deposit_id_to">Receiver account number:</label>
				<input type="text" class="form-control" name="deposit_id_to" id="deposit_id_to" placeholder="Account number">
			</div>
			<div class="form-group">
