...
<nav class="navbar navbar-light bg-light">
	<div class="navbar-header">
		<form class="form-inline p-10">
			...
			<a href="#" class="btn btn-outline-secondary active" role="button">Move</a>
...
<div class="row">
	...
	<div class="col-sm-4 mb">
		<h4 class="mb-4 mt-3 ml-3">Move money</h4>
		<form method="post">
			<div class="form-group">
				...
				%>
				<label for="deposit_id_from">Sender account number:</label>
